  ...
  * [18. API](https://www.zabbix.com/documentation/3.2/manual/api)
    * [Method reference](https://www.zabbix.com/documentation/3.2/manual/api/reference)
      ...
      * [User group](/documentation/3.2/manual/api/reference/usergroup)
        ...
        * [usergroup.create](/documentation/3.2/manual/api/reference/usergroup/create "usergroup.create")
        * [usergroup.delete](/documentation/3.2/manual/api/reference/usergroup/delete "usergroup.delete")
        * [usergroup.get](/documentation/3.2/manual/api/reference/usergroup/get)
        * [usergroup.isreadable](/documentation/3.2/manual/api/reference/usergroup/isreadable "usergroup.isreadable")
        * [usergroup.iswritable](/documentation/3.2/manual/api/reference/usergroup/iswritable "usergroup.iswritable")
        * [usergroup.massadd](/documentation/3.2/manual/api/reference/usergroup/massadd "usergroup.massadd")
        * [usergroup.massupdate](/documentation/3.2/manual/api/reference/usergroup/massupdate "usergroup.massupdate")
        * [usergroup.update](/documentation/3.2/manual/api/reference/usergroup/update "usergroup.update")
      * [User macro](/documentation/3.2/manual/api/reference/usermacro "User macro")
        * [>&gt; User macro object](/documentation/3.2/manual/api/reference/usermacro/object)
        * [usermacro.create](/documentation/3.2/manual/api/reference/usermacro/create "usermacro.create")
        * [usermacro.createglobal](/documentation/3.2/manual/api/reference/usermacro/createglobal "usermacro.createglobal")
        * [usermacro.delete](/documentation/3.2/manual/api/reference/usermacro/delete "usermacro.delete")
        * [usermacro.deleteglobal](/documentation/3.2/manual/api/reference/usermacro/deleteglobal "usermacro.deleteglobal")
        * [usermacro.get](/documentation/3.2/manual/api/reference/usermacro/get "usermacro.get")
        * [usermacro.update](/documentation/3.2/manual/api/reference/usermacro/update "usermacro.update")
        * [usermacro.updateglobal](/documentation/3.2/manual/api/reference/usermacro/updateglobal "usermacro.updateglobal")
      * [Value map](/documentation/3.2/manual/api/reference/valuemap "Value map")
        * [>&gt; Value map object](/documentation/3.2/manual/api/reference/valuemap/object)
        * [valuemap.create](/documentation/3.2/manual/api/reference/valuemap/create "valuemap.create")
        * [valuemap.delete](/documentation/3.2/manual/api/reference/valuemap/delete "valuemap.delete")
        * [valuemap.get](/documentation/3.2/manual/api/reference/valuemap/get "valuemap.get")
        * [valuemap.update](/documentation/3.2/manual/api/reference/valuemap/update "valuemap.update")
      * [Web scenario](/documentation/3.2/manual/api/reference/httptest "Web scenario")
        * [>&gt; Web scenario object](/documentation/3.2/manual/api/reference/httptest/object)
        * [httptest.create](/documentation/3.2/manual/api/reference/httptest/create "httptest.create")
        * [httptest.delete](/documentation/3.2/manual/api/reference/httptest/delete "httptest.delete")
        * [httptest.get](/documentation/3.2/manual/api/reference/httptest/get "httptest.get")
        * [httptest.isreadable](/documentation/3.2/manual/api/reference/httptest/isreadable "httptest.isreadable")
        * [httptest.iswritable](/documentation/3.2/manual/api/reference/httptest/iswritable "httptest.iswritable")
        * [httptest.update](/documentation/3.2/manual/api/reference/httptest/update "httptest.update")
